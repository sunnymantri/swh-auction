-- =====================================================================
--  Cricket Auction App  •  0027_reauction_min_player_floor.sql
--  Re-auction bids may go below base price, but never below
--  auction.min_player_price. This floor is enforced for all bid paths,
--  including override/manual bids.
-- =====================================================================
